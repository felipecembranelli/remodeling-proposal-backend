...
using LandscapingProposalSystem.Core.LLM;
using LandscapingProposalSystem.Core.Models;
using LandscapingProposalSystem.Infrastructure.LLM.Models;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;

namespace LandscapingProposalSystem.Infrastructure.LLM
{
    public class SemanticKernelPoc : BaseLLMService
    {
            ...
            string siteAnalysis)
        {
            try
            {
                ...
                var companyStandards = GetLandscapingCompanyStandards();

                // Get similar projects images
                var similarProjectsImages = GetSimiliarProjectsImages(propertyType, propertySize);
